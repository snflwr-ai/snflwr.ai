...
OLLAMA_DEFAULT_MODEL=gemma4:e4b       # auto-selected by RAM detection
...
base model whose size the installer chooses from your hardware. On systems
with 16 GB+ RAM the default is **`gemma4:e4b`** (it won the June 2026 tutoring
