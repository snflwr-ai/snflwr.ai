...
By creating an account or using snflwr.ai ("Service"), you ("Parent," "you") agree to these Terms of Service. If you do not agree, do not use the Service.

**For Parents:** You must be 18+ years old to create an account. By creating a child profile, you consent to collection and use of your child's data as described in our Privacy Policy.
...
**snflwr.ai** is a K-12 safe AI learning platform that:
- Provides AI-powered tutoring for students (ages 5-18)
- Enforces backend safety monitoring that cannot be bypassed
- Alerts parents to safety concerns
- Complies with COPPA and FERPA
...
**Creation:**
- Parents create profiles for children
- First name only (no last names)
- Accurate age/grade information required
- Parents consent to data collection

**Limitations:**
- Children cannot create own accounts
- Children cannot access parent account
- Children cannot bypass safety monitoring
...
- Age-appropriate academic assistance
- Personal study and homework help

### 3.2 Prohibited Uses

You agree **NOT** to:
- Attempt to bypass safety filters
- Use service for commercial purposes
...
**Safety Pipeline:**
- 5-stage content filtering (input validation, normalization, pattern matching, semantic classification, age gate)
- Cannot be disabled or bypassed by students
- Logs all safety incidents
- Alerts parents as configured

**Parent Notifications:**
- Critical incidents: Immediate email
- Major incidents: After threshold (default: 2)
- Minor incidents: Daily digest

### 4.2 Parent Responsibilities

Parents agree to:
- Monitor child's use of the Service
- Review safety incident reports
- Take appropriate action when alerted
- Supervise young children (under 8)

**We Are Not Responsible For:**
- Parental supervision
- Enforcement of household rules
- Monitoring use outside our Service
- Consequences of child's behavior
...
**We Own:**
- snflwr.ai platform and software
...
**You Own:**
- Content you or your child creates
- Chat messages and conversations
- Profile information

**License to Us:**
- You grant us right to process content for Service delivery
- We may use aggregated, anonymized data for improvement
- We will not use your child's data for advertising
...
- Access child's data
- Modify child's information
- Delete child's data
- Export data (JSON format)
- Withdraw consent

**Exercise Rights:**
- Login → Parent Dashboard → Settings
...
- May experience downtime for maintenance
- Features may change without notice

### 8.2 Educational Disclaimer

**Not Professional Services:**
- AI assistance is supplemental, not a replacement for teachers
- Not certified tutoring or professional education
- Parents responsible for child's education
- AI may make mistakes

### 8.3 Safety Disclaimer

**Best Efforts:**
- Safety monitoring uses industry best practices
- Cannot guarantee 100% blocking of all inappropriate content
...
- Location: Your county of residence
- Costs: We pay (up to $10,000)
...
- Opt-out: Email legal@snflwr.ai within 30 days
...
- Enforceable to maximum extent permitted

### 13.3 Entire Agreement

- These Terms, Privacy Policy, and DPA constitute entire agreement
...
**Material Changes:**
- Email notice 30 days in advance
...
Previous versions available at: [Link]
